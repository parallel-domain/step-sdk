...
from pd.internal.proto.keystone.generated.python import pd_levelcook_pb2
...
class LevelCookInfo(ProtoMessageClass):
    ...
    def __init__(self, *, proto: Optional[pd_levelcook_pb2.LevelCookInfo]=None, artifact_key: Optional[str]=None, location_list: Optional[List[LevelCookInfo.Location]]=None, output_artifact_uid: Optional[str]=None):
        if proto is None:
