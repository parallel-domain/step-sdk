...
class KeystoneBuildMessage(_message.Message):
    ...
    class PipelineStage(_message.Message):
        __slots__ = ["build_sim_state", "field_encoder", "le_encoder", "levelcook", "package_maps_from_p4", "qa_processor", "render", "sim_state_cull", "source_maps", "world_cook_from_p4", "worldbuild", "worldgen"]
